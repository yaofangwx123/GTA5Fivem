...
function StartDriveTest(type)
	ESX.Game.SpawnVehicle(Config.VehicleModels[type], vector3(Config.Zones.VehicleSpawnPoint.Pos.x, Config.Zones.VehicleSpawnPoint.Pos.y, Config.Zones.VehicleSpawnPoint.Pos.z), Config.Zones.VehicleSpawnPoint.Pos.h, function(vehicle)
		...
		--xp_add
		TriggerEvent('xp:client:HandleAllowVehicle', {plate = GetVehicleNumberPlateText(vehicle),isNeedLicensce = false,isReg = true})
...
function StopDriveTest(success)
	...
	--xp_add
	TriggerEvent('xp:client:HandleAllowVehicle',{plate = GetVehicleNumberPlateText(CurrentVehicle),isNeedLicensce = false,isReg = false})
end
...
ownedLicenses['dmv'] = "aa"
	...
	if ownedLicenses['dmv'] then
		...
		elseif not ownedLicenses['drive'] then
			elements[#elements+1] = {
				icon = "fas fa-car",
		...
		elseif not ownedLicenses['drive_truck'] then
			elements[#elements+1] = {
				icon = "fas fa-car",
