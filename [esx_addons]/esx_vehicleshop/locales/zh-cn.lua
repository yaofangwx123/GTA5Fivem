Locales['zh-cn'] = {
  ...
  ['sell_mycar']              = '键下 [E] 出售拥有的车辆',
  ['sell_mycar_title']        = '选中您要出售的车辆',
  ['sell_mycar_nocar']        = '您没有车辆可出售',
  ['sell_mycar_sell_sucess']  = '您的车辆已经出售！',
  ['sell_mycar_sell_fail']    = '您的车辆出售失败...',
  
   ['repair_mycar']              = '键下 [E] 修理您的车辆 %s',
   ['sell_reparemycar_title']    = '修理费用',
   ['sell_repairmycar_nocar']    = '您没有可修理的车辆',
   ['sell_repairmycar_ok']       = '您的车辆已经修理完成',
}
