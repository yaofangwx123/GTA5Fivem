...
Config.SaveDeathStatus              = false -- Save Death Status?
Config.LoadIpl                    = true -- Disable if you're using fivem-ipl or other IPL loaders
Config.localRespawn               = true
Config.respawnFineAccount         = 50000
Config.bloodTimeOutEnable         = false
...
Config.EarlyRespawnTimer          = 5000 * 1  -- time til respawn is available
