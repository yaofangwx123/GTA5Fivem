...
if not Config.Disable.Vehicle then
	...
	local function enterVehicle(currentVehicle, currentPlate, currentSeat, displayName, netId)
	
		if(currentSeat~=-1 or HUD.Data.Driver) then return end
    ...
    AddEventHandler("esx:enteredVehicle", function(currentVehicle, currentPlate, currentSeat, displayName, netId)
       enterVehicle(currentVehicle, currentPlate, currentSeat, displayName, netId)
    end)
	
	
	  AddEventHandler("esx:vehicleSeatChange", function(currentVehicle, currentPlate, currentSeat, displayName, netId)
        enterVehicle(currentVehicle, currentPlate, currentSeat, displayName, netId)
    end)
